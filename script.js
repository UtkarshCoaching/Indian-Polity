const questions = [
  {
    ...
    "options": [
      ...
      "একটি দেশের সর্বোচ্চ আইন, যার মাধ্যমে শাসনপ্রণালী ও নাগরিকদের অধিকার নির্ধারিত হয়",
      "একটি দেশের সামরিক নীতি",
      "একটি দেশের সংস্কৃতি ও ঐতিহ্যের সমষ্টি"
    ],
    "answer": "একটি দেশের সর্বোচ্চ আইন, যার মাধ্যমে শাসনপ্রণালী ও নাগরিকদের অধিকার নির্ধারিত হয়",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতের সংবিধান প্রণয়নের মূল উদ্দেশ্য কী ছিল?",
    "options": [
      "ভারতকে একটি শিল্পোন্নত রাষ্ট্র হিসেবে প্রতিষ্ঠা করা",
      "ভারতকে একটি কৃষিপ্রধান রাষ্ট্র হিসেবে প্রতিষ্ঠা করা",
      "ভারতকে একটি গণতান্ত্রিক, ধর্মনিরপেক্ষ, প্রজাতান্ত্রিক রাষ্ট্র হিসেবে প্রতিষ্ঠা করা",
      "ভারতকে একটি এককেন্দ্রিক রাষ্ট্র হিসেবে প্রতিষ্ঠা করা"
    ],
    "answer": "ভারতকে একটি গণতান্ত্রিক, ধর্মনিরপেক্ষ, প্রজাতান্ত্রিক রাষ্ট্র হিসেবে প্রতিষ্ঠা করা",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতীয় সংবিধানের খসড়া কে তৈরি করেন?",
    "options": [
      "জওহরলাল নেহরু",
      "মহাত্মা গান্ধী",
      "ড. বি. আর. আম্বেডকর",
    ...
    "answer": "ড. বি. আর. আম্বেডকর",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতীয় সংবিধান কবে গৃহীত হয়?",
    "options": [
      "১৫ আগস্ট ১৯৪৭",
      "২৬ জানুয়ারি ১৯৫০",
      "২৬ নভেম্বর ১৯৪৯",
    ...
    "answer": "২৬ নভেম্বর ১৯৪৯",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতীয় সংবিধান কবে কার্যকর হয়?",
    "options": [
      "১৫ আগস্ট ১৯৪৭",
      "২৬ জানুয়ারি ১৯৫০",
      "২৬ নভেম্বর ১৯৪৯",
  ...
  {
    "question": "সংবিধান সভার প্রথম অধিবেশন কবে বসে?",
    "options": [
      "১৫ আগস্ট ১৯৪৭",
      "২৬ জানুয়ারি ১৯৫০",
      "২৬ নভেম্বর ১৯৪৯",
    ...
    "answer": "৯ ডিসেম্বর ১৯৪৬",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতীয় সংবিধানকে বিশ্বের বৃহত্তম সংবিধান বলা হয় কেন?",
    "options": [
      "এটি সবচেয়ে বেশি ভাষা দ্বারা লিখিত",
      "এটি বিশ্বের সবচেয়ে পুরাতন সংবিধান",
      "কারণ এতে প্রথমে ৩৯৫টি ধারা, ২২টি অংশ, ৮টি তফসিল ছিল, যা পরে বেড়ে ৪৪৮টি ধারা, ২৫টি অংশ ও ১২টি তফসিল হয়",
      "এটি কেবল একটি দেশের সংবিধান নয়, বিভিন্ন দেশের সংবিধানের সমষ্টি"
    ],
    "answer": "কারণ এতে প্রথমে ৩৯৫টি ধারা, ২২টি অংশ, ৮টি তফসিল ছিল, যা পরে বেড়ে ৪৪৮টি ধারা, ২৫টি অংশ ও ১২টি তফসিল হয়",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "সংবিধানের মূল খসড়া কবে সম্পূর্ণ হয়?",
    "options": [
      "১৫ আগস্ট ১৯৪৭",
      "২৬ জানুয়ারি ১৯৫০",
      "২৬ নভেম্বর ১৯৪৯",
  ...
  {
    "question": "'সার্বভৌম গণতান্ত্রিক প্রজাতন্ত্র' শব্দগুলো কোথা থেকে গৃহীত?",
    "options": [
      "ভারত শাসন আইন, ১৯৩৫",
      "ব্রিটিশ সংবিধান",
      "১৯৪৬ সালের \"উদ্দেশ্য প্রস্তাব\" (Objective Resolution) থেকে",
      "মার্কিন যুক্তরাষ্ট্রের সংবিধান"
    ],
    "answer": "১৯৪৬ সালের \"উদ্দেশ্য প্রস্তাব\" (Objective Resolution) থেকে",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "1946 সালের 16 মে কোন পরিকল্পনা ঘোষিত হয়?",
    "options": [
      "মাউন্টব্যাটেন পরিকল্পনা",
      "ক্যাবিনেট মিশন পরিকল্পনা",
      "ক্রিপস মিশন পরিকল্পনা",
      "সাইমন কমিশন"
    ],
  ...
  {
    "question": "গণপরিষদের মোট সদস্য সংখ্যা কত ছিল?",
    "options": [
      "২৯৬ জন",
      "৩৮৯ জন",
      "৩৫০ জন",
  ...
  {
    "question": "গণপরিষদের কতজন সদস্য প্রত্যক্ষভাবে নির্বাচিত হয়েছিলেন?",
    "options": [
      "২৫০ জন",
      "২৯৬ জন",
      "৩০০ জন",
  ...
  {
    "question": "সংবিধান গঠনে মোট কতদিন সময় লেগেছিল?",
    "options": [
      "১ বছর ৬ মাস ১০ দিন",
      "২ বছর ১১ মাস ১৮ দিন",
      "৩ বছর ০ মাস ৫ দিন",
  ...
  {
    "question": "গণপরিষদের সভাপতি কে ছিলেন?",
    "options": [
      "ড. বি. আর. আম্বেডকর",
      "জওহরলাল নেহরু",
      "ড. রাজেন্দ্র প্রসাদ",
  ...
  {
    "question": "সংবিধান খসড়া কমিটির চেয়ারম্যান কে ছিলেন?",
    "options": [
      "ড. রাজেন্দ্র প্রসাদ",
      "জওহরলাল নেহরু",
      "ড. বি. আর. আম্বেডকর",
  ...
  {
    "question": "সংবিধান খসড়া কমিটির নাম কী?",
    "options": [
      "Fundamental Rights Committee",
      "Union Powers Committee",
      "Drafting Committee (খসড়া প্রস্তুত কমিটি)",
      "Advisory Committee"
    ],
    "answer": "Drafting Committee (খসড়া প্রস্তুত কমিটি)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ইউনিয়নের ক্ষমতা সম্পর্কিত কমিটির নেতৃত্বে কে ছিলেন?",
    "options": [
      "ড. বি. আর. আম্বেডকর",
      "জওহরলাল নেহরু",
      "সরদার পটেল",
  ...
  {
    "question": "মৌলিক অধিকারের কমিটির সভাপতি কে ছিলেন?",
    "options": [
      "জওহরলাল নেহরু",
      "সরদার পটেল",
      "ড. রাজেন্দ্র প্রসাদ",
  ...
  {
    "question": "নাগরিকত্ব সম্পর্কিত কমিটির দায়িত্বে কে ছিলেন?",
    "options": [
      "ড. রাজেন্দ্র প্রসাদ",
      "জওহরলাল নেহরু",
      "সরদার পটেল",
  ...
  {
    "question": "সংবিধান সভার মোট কতটি প্রধান কমিটি ছিল?",
    "options": [
      "১০টি",
      "১২টি",
      "১৩টি",
  ...
  {
    "question": "ভারতীয় সংবিধান প্রণয়নের উৎস কী কী?",
    "options": [
      "শুধুমাত্র ব্রিটিশ সংসদ আইন",
      "মার্কিন যুক্তরাষ্ট্রের সংবিধান ও কানাডার সংবিধান",
      "ভারত শাসন আইন, ১৯৩৫, ব্রিটিশ সংসদ আইন, মার্কিন যুক্তরাষ্ট্রের সংবিধান, ইত্যাদি",
      "শুধুমাত্র ভারত শাসন আইন, ১৯৩৫"
    ],
    "answer": "ভারত শাসন আইন, ১৯৩৫, ব্রিটিশ সংসদ আইন, মার্কিন যুক্তরাষ্ট্রের সংবিধান, ইত্যাদি",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "সংবিধান প্রণয়নে ভারতের কোন আইনকে ভিত্তি হিসেবে নেওয়া হয়?",
    "options": [
      "বিশেষভাবে ভারত শাসন আইন, ১৯৩৫",
      "রেগুলেটিং অ্যাক্ট, ১৭৭৩",
      "ভারত স্বাধীনতা আইন, ১৯৪৭",
      "পিটস ইন্ডিয়া অ্যাক্ট, ১৭৮৪"
    ],
    "answer": "বিশেষভাবে ভারত শাসন আইন, ১৯৩৫",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "সংবিধানে আইন প্রণয়ন প্রক্রিয়াকে কী নামে ডাকা হয়?",
    "options": [
      "Executive Procedure",
      "Judicial Review",
      "Legislative Procedure (আইন প্রণয়নের পদ্ধতি)",
      "Amendment Procedure"
    ],
    "answer": "Legislative Procedure (আইন প্রণয়নের পদ্ধতি)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "'ফার্স্ট পাস্ট দ্য পোস্ট' ব্যবস্থা কী?",
    "options": [
      "যে প্রার্থী সবচেয়ে কম ভোট পায়, সে নির্বাচিত হয়",
      "যে প্রার্থী সবচেয়ে বেশি ভোট পায়, সে নির্বাচিত হয় – এটি একটি সাধারণ ভোট গণনা পদ্ধতি",
      "আনুপাতিক প্রতিনিধিত্বের একটি পদ্ধতি",
      "লটারির মাধ্যমে প্রার্থী নির্বাচন"
    ],
    "answer": "যে প্রার্থী সবচেয়ে বেশি ভোট পায়, সে নির্বাচিত হয় – এটি একটি সাধারণ ভোট গণনা পদ্ধতি",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "1946 সালে ভারতবর্ষে অন্তর্বর্তী সরকার কবে গঠিত হয়?",
    "options": [
      "১৫ আগস্ট ১৯৪৬",
      "২ সেপ্টেম্বর ১৯৪৬",
      "২৬ অক্টোবর ১৯৪৬",
